...
static long init_bo_KL2798(struct boRecord * pbo)
{
	SINT32 status;
	...
	if(Bk9000_Signal_Init((dbCommon *) pbo, EPICS_RTYPE_BO, pbo->out.value.instio.string, BT_TYPE_KL2798, Bk9000_Dft_ProcFunc, NULL) != 0)
	{
...
static long write_bo_KL2798(struct boRecord * pbo)
{
...
epicsExportAddress(dset, devBoKL2798);
