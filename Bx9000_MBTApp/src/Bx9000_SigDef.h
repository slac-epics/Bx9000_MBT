...
static	BUSTERM_SIG_PREDEF	busterm_sig_predef[]= {
	...
	{"KL3404", BT_TYPE_KL3404, "R_ANA_IN_1",        BT_OPTYPE_READ_INPUT_CIMG,      EPICS_RTYPE_AI, DTYP_SINT16,    1, 1, 15},/* 12 bits << 3 */
	{"KL3404", BT_TYPE_KL3404, "R_ANA_IN_2",        BT_OPTYPE_READ_INPUT_CIMG,      EPICS_RTYPE_AI, DTYP_SINT16,    3, 1, 15},/* 12 bits << 3 */
	{"KL3404", BT_TYPE_KL3404, "R_ANA_IN_3",        BT_OPTYPE_READ_INPUT_CIMG,      EPICS_RTYPE_AI, DTYP_SINT16,    5, 1, 15},/* 12 bits << 3 */
	{"KL3404", BT_TYPE_KL3404, "R_ANA_IN_4",        BT_OPTYPE_READ_INPUT_CIMG,      EPICS_RTYPE_AI, DTYP_SINT16,    7, 1, 15},/* 12 bits << 3 */
