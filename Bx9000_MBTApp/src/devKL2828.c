...
static long init_bo_KL2828(struct boRecord * pbo)
{
	SINT32 status;
	...
	if (pbo->out.type!=INST_IO)
	{
		recGblRecordError(S_db_badField, (void *)pbo,
			"devBoKL2828 Init_record, Illegal OUT");
		pbo->pact=TRUE;
	...
	if(Bk9000_Signal_Init((dbCommon *) pbo, EPICS_RTYPE_BO, pbo->out.value.instio.string, BT_TYPE_KL2828, Bk9000_Dft_ProcFunc, NULL) != 0)
	{
...
static long write_bo_KL2828(struct boRecord * pbo)
{
...
epicsExportAddress(dset, devBoKL2828);
